...
<head>
    ...
    <!-- Bootstrap 3.3.4 -->
    <link rel="stylesheet" href='{{asset("/assets/ar/css/bootstrap.min.css")}}'>
    <!-- Font Awesome -->
    ...
    <link rel="stylesheet" href='{{ asset("/assets/ar/css/skins/_all-skins.min.css") }}'>
    <link rel="stylesheet" href='{{ asset("/assets/ar/css/mystyle.css") }}'>
