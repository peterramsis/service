...
<section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">    {{ __("update question") }}</li>
    </ol>
  </section>
@endsection
@section("content")
...
<div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">   {{ __("update question") }}</h3>
        ...
        <div class="box-body" style="">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="form" method="POST" action="{{ route("updateQuestion",$question->id) }}" role="form">
                        @csrf

                        <div class="box-body">
                            <div class="form-group">
                                <label>{{ trans("qu.question arabic") }}</label>
                                <input class="form-control form-control-lg" type="text"  name="question_ar" value="{{$question->question_ar }}">
                              </div>
                            <div class="form-group">
